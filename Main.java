...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * Metodo que crea el fichero syslog.txt en caso de que no exista al iniciar la ejecucion del programa
		 */
		Log.createFile();
		
		/*
		 * Se guarda el evento de inicio del programa
		 */
		Log.loggerEvents("Inicio del programa", "Inicio sin errores");//Evento
		
		// Mensaje de bienvenida
		System.out.println(Config.WELCOME);
		// Mensaje de nota con respecto a la implementacion de las nuevas funcionalidades
