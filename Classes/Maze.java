...
public class Maze { 
	...
	public void setEntranceExit() {
		...
		System.out.println("\nIntroduce las coordenadas para la casilla de ENTRADA -->");
			...
			// Restriccion con un bucle para que en caso de que las coordenadas indicadas queden sobre una alhomadilla,
			// se llame al metodo booleano restrictionEntrance() donde realiza dicha comprobacion de la almohadilla
			// El bucle se estara recorriendo tantas veces como el metodo de true, y al final del bucle se llamara
			// a dicho metodo, y se vuelve a verificar. En caso de la casilla este correcta, al llamar al metodo
			// se devolvera false, y el bucle finaliza.
			boolean constraintEntrance = restrictionEntrance();
			while (constraintEntrance == true) {
				...
				constraintEntrance = restrictionEntrance();
			}
		...
		System.out.println("\nIntroduce las coordenadas para la casilla de SALIDA -->");
			...
			// Restriccion con un bucle para que en caso de que las coordenadas indicadas queden sobre una alhomadilla,
			// se llame al metodo booleano restrictionExit() donde realiza dicha comprobacion de la almohadilla
			// El bucle se estara recorriendo tantas veces como el metodo de true, y al final del bucle se llamara
			// a dicho metodo, y se vuelve a verificar. En caso de la casilla este correcta, al llamar al metodo
			// se devolvera false, y el bucle finaliza.
			boolean constraintExit = restrictionExit();
			while (constraintExit == true) {
				System.out.println("\nCoordenadas no validas."
				...
				constraintExit = restrictionExit();
			}
