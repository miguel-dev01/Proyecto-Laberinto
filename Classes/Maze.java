...
public class Maze { 
	...
	public void setEntranceExit() {
		...
		System.out.println("\nIntroduce las coordenadas para la casilla de ENTRADA -->");
			startI = Interface.getInt("\tIntroduce num fila entrada: ");
			startJ = Interface.getInt("\tIntroduce num columna entrada: ");
		...
		System.out.println("\nIntroduce las coordenadas para la casilla de SALIDA -->");
			endI = Interface.getInt("\tIntroduce num fila salida: ");
			endJ = Interface.getInt("\tIntroduce num columna salida: ");
	...
	// TODO probar metodo que use OR para saber si la casilla de entrada y salida esta sobre la pared laberinto
