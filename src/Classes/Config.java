...
public class Config {
	...
	public static final String UPDATE_DATA_USER = "\nAntes de comenzar con la modificacion de datos de usuario. A la hora de introducir nuevos datos\ntenga en cuenta las consideraciones para registrar un usuario correctamente\n\nMODIFICACION DE DATOS DE USUARIO\n---------------------------------\nElige una:\n1 - Nombre\n2 - Contraseña\n3 - NIF\n4 - Email\n5 - Address\n6 - Birthdate";
