...
public class Session {
	...
	public void login() {
		...
		try {
			...
			System.err.println("Error al iniciar sesion en la base de datos");
		}
	...
	/**
	 * Metodo adicional igual que el de logout(), solo que, sin mensaje por consola ni registro de log
	 */
	public void logout2() {
		logged = false;
		user = new User();
